class Company {
    ...
    bestDepartment() {
        ...
        for (const department in this.departments) {
            ...
            if (
                this.departments[department].avgSalary > bestDepartmentAvgSalary
            ) {
                bestDepartmentAvgSalary =
                    this.departments[department].avgSalary;
...
c.addEmployee("dsfsdf", 2000, "engineer", "Construction");
...
c.addEmployee("Stanimir", 10, "digital marketing manager", "Marketing");
